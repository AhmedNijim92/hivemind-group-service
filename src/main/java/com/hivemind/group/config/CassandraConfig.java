...
@Configuration
@EnableCassandraRepositories(basePackages = "com.hivemind.group.repository")
public class CassandraConfig extends AbstractCassandraConfiguration
{
    @Value("${spring.cassandra.keyspace-name:group_keyspace}")
    ...
    @Override
    public String[] getEntityBasePackages() { return new String[]{"com.hivemind.group.entity"}; }
